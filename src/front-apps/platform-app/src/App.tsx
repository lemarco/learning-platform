...
const AppleSVG = () => (
  // biome-ignore lint/a11y/noSvgWithoutTitle: <explanation>
  <svg className="mr-2 h-5 w-5 text-gray-900 dark:text-white" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const RegisterFormWithDescription: FC = () => (
  <section className="bg-white dark:bg-gray-900">
    <div className="grid lg:h-screen lg:grid-cols-2">
      <div className="flex items-center justify-center px-4 py-6 sm:px-0 lg:py-0">
        <form className="max-w-md space-y-4 md:space-y-6 xl:max-w-xl" action="#">
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            <TextInput id="email" name="full-name" placeholder="e.g. Bonnie Green" required />
          </div>
          <div className="grid grid-cols-1 gap-2">
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              <div className="flex h-5 items-center">
                <Checkbox aria-describedby="terms-description" id="terms-description" required />
              </div>
            ...
            <div className="flex items-start">
              <div className="flex h-5 items-center">
                <Checkbox aria-describedby="terms-description-2" id="terms-description-2" required />
              </div>
              <div className="ml-3 text-sm">
                <Label htmlFor="terms-description-2" className="text-gray-500 dark:text-gray-300">
      ...
      <div className="flex items-center justify-center bg-primary-600 px-4 py-6 sm:px-0 lg:py-0">
        <div className="max-w-md xl:max-w-xl">
          ...
          <p className="mb-4 text-primary-200 lg:mb-8">
            Millions of designers and agencies around the world showcase their portfolio work on Flowbite - the home to the world’s best
            design and creative professionals.
          </p>
          <div className="flex items-center divide-x divide-primary-500">
            <Avatar.Group className="pr-6">
              <Avatar img="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" rounded stacked />
              <Avatar img="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" rounded stacked />
              <Avatar img="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/roberta-casas.png" rounded stacked />
...
export default RegisterFormWithDescription;
