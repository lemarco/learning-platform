...
import type { ElementNode, LexicalCommand, LexicalNode, NodeKey } from "../../lib/lexical-editor";
...
import { $createParagraphNode, $getNodeByKey, COMMAND_PRIORITY_EDITOR, createCommand } from "../../lib/lexical-editor";
