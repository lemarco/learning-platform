import type { TextNode } from "../lexical-editor";

import { useCallback, useEffect } from "react";
import { $createHashtagNode, HashtagNode } from "../lexical-editor";
...
function getHashtagRegexString(): string {
  ...
  // but not all numbers.
  const hashtag =
    "(" + hashtagBoundary + ")(" + hashCharList + ")(" + hashtagAlphanumeric + "*" + hashtagAlpha + hashtagAlphanumeric + "*)";
