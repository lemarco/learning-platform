...
import { addClassNamesToElement, isHTMLElement, removeClassNamesFromElement } from "../../lexical-utils/LexicalUtils";
import {
...
function $setListItemThemeClassNames(dom: HTMLElement, editorThemeClasses: EditorThemeClasses, node: ListItemNode): void {
  const classesToAdd = [];
