...
function destroyChildren(children: Array<NodeKey>, _startIndex: number, endIndex: number, dom: null | HTMLElement): void {
...
function createChildrenWithDirection(children: Array<NodeKey>, endIndex: number, element: ElementNode, dom: HTMLElement): void {
...
function reconcileElementTerminatingLineBreak(prevElement: null | ElementNode, nextElement: ElementNode, dom: HTMLElement): void {
  const prevLineBreak =
    prevElement !== null && (prevElement.__size === 0 || isLastChildLineBreakOrDecorator(prevElement.__last as NodeKey, activePrevNodeMap));
  const nextLineBreak = nextElement.__size === 0 || isLastChildLineBreakOrDecorator(nextElement.__last as NodeKey, activeNextNodeMap);
