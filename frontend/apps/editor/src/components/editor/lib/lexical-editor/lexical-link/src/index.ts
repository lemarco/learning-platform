...
import { addClassNamesToElement, isHTMLAnchorElement } from "../../lexical-utils/LexicalUtils";
import {
...
export const TOGGLE_LINK_COMMAND: LexicalCommand<string | ({ url: string } & LinkAttributes) | null> = createCommand("TOGGLE_LINK_COMMAND");
