...
import { IS_APPLE_WEBKIT, IS_FIREFOX, IS_IOS, IS_SAFARI } from "../../shared/src/environment";
...
export const COMPOSITION_SUFFIX: string = IS_SAFARI || IS_IOS || IS_APPLE_WEBKIT ? NON_BREAKING_SPACE : ZERO_WIDTH_SPACE;
