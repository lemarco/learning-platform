import type { CodeHighlightNode } from "../../lexical-code/LexicalCode";
...
export class CodeNode extends ElementNode {
  ...
  // Mutation
  insertNewAfter(selection: RangeSelection, restoreSelection = true): null | ParagraphNode | CodeHighlightNode | TabNode {
