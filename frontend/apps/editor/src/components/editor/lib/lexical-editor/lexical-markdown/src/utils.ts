import type { ListNode } from "../../lexical-list/LexicalList";
...
import type { ElementNode, LexicalNode, TextFormatType } from "../../lexical/Lexical";

import { $isCodeNode } from "../../lexical-code/LexicalCode";
import { $isListItemNode, $isListNode } from "../../lexical-list/LexicalList";
import { $isHeadingNode, $isQuoteNode } from "../../lexical-rich-text/LexicalRichText";
