import type { KlassConstructor, Spread } from "../../../lexical/Lexical";
...
import { $getSelection, $isRangeSelection, internalMakeRangeSelection, moveSelectionPointToSibling } from "../LexicalSelection";
...
function isPointRemoved(point: PointType, nodesToRemoveKeySet: Set<NodeKey>, nodesToInsertKeySet: Set<NodeKey>): boolean {
