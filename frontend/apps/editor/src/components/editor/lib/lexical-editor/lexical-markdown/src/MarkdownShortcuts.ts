...
import type { ElementNode, LexicalEditor, TextNode } from "../../lexical/Lexical";
...
export function registerMarkdownShortcuts(editor: LexicalEditor, transformers: Array<Transformer> = TRANSFORMERS): () => void {
