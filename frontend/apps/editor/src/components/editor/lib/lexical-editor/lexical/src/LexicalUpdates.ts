...
import { EditorState, cloneEditorState, createEmptyEditorState, editorStateHasDirtySelection } from "./LexicalEditorState";
...
export function $applyTransforms(editor: LexicalEditor, node: LexicalNode, transformsCache: Map<string, Array<Transform<LexicalNode>>>) {
  ...
  if (
    ...
    try {
      ...
      if (needsUpdate || pendingSelection === null || pendingSelection.dirty) {
        ...
        updateDOMSelection(currentSelection, pendingSelection, editor, domSelection, tags, rootElement as HTMLElement, nodeCount);
      }
...
function triggerTextContentListeners(editor: LexicalEditor, currentEditorState: EditorState, pendingEditorState: EditorState): void {
