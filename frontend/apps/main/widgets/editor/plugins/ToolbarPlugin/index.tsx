...
export default function ToolbarPlugin({
  ...
  return (
    <div className="flex mb-1 bg-slate-50 p-1 rounded-t-lg align-middle overflow-auto h-9 sticky top-0 z-2  ">
      <ButtonGroup>
        <Button
        ...
        <Select disabled={!isEditable} icon={ParagraphIcon} shadow>
      ...
      {/* <Dropdown label="Normal">
        ...
        <Dropdown.Item>Bullet List</Dropdown.Item>
        <Dropdown.Item>Numbered List</Dropdown.Item>
        <Dropdown.Item>Check List</Dropdown.Item>
        <Dropdown.Item>Quote</Dropdown.Item>
        <Dropdown.Item>Code Blocks</Dropdown.Item>
      </Dropdown> */}
      {/* <Select>
