        ...
        <div>
          <div className="mb-10">
            ...
            <ul className="mb-4 list-disc pl-4">
              ...
              <li className="mb-2 text-gray-600">
                <span className="cursor-pointer font-medium text-primary-600 hover:underline dark:text-primary-500">
                  Figma Files + Tailwind CSS code pre-order - Buy a team license
                  for <del>$699</del> $559 USD
                </span>
              </li>
        ...
        <div>
          ...
          <div className="mb-10">
            ...
            <p className="mb-4 text-gray-600 dark:text-gray-400">
              ...
              code for your company. This will also remove the extra VAT tax
              from the purchase.
            </p>
          </div>
          <div className="mb-10">
            ...
            <p className="mb-4 text-gray-600 dark:text-gray-400">
              ...
              arrive on the 25th of September 2021, you can get a base 20% price
