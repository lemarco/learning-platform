...
const RegisterFormWithIllustration: FC = () => (
  <section className="bg-gray-50 dark:bg-gray-900 h-full">
    <div className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-20 lg:py-16">
      <div className="mx-auto w-full rounded-lg bg-white p-6 shadow dark:bg-gray-800 sm:max-w-xl sm:p-8 lg:col-span-6">
        <a href="/" className="mb-4 inline-flex items-center text-xl font-semibold text-gray-900 dark:text-white">
          <img alt="logo" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg" className="mr-2 h-8 w-8" />
          Flowbite
        </a>
        <h1 className="mb-2 text-2xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white">Create your Account</h1>
        ...
        <form className="m-auto mt-4 space-y-6 sm:mt-6" action="#">
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              <div className="flex h-5 items-center">
                <Checkbox aria-describedby="terms-illustrations" id="terms-illustrations" required />
              </div>
              <div className="ml-3 text-sm">
                <Label htmlFor="terms-illustrations" className="text-gray-500 dark:text-gray-300">
            ...
            <div className="flex items-start">
              <div className="flex h-5 items-center">
                <Checkbox aria-describedby="newsletter" id="newsletter" required />
              </div>
              <div className="ml-3 text-sm">
