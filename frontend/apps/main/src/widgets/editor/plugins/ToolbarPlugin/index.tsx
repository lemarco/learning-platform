...
const { $createCodeNode, $isCodeNode, CODE_LANGUAGE_FRIENDLY_NAME_MAP, CODE_LANGUAGE_MAP, getLanguageFriendlyName } = LexCode;
...
import LexicalDecoratorBlockNode from "@lexical/react/LexicalDecoratorBlockNode";
const { $isDecoratorBlockNode } = LexicalDecoratorBlockNode;
...
import LexRichText, { HeadingTagType } from "@lexical/rich-text";
const { $createHeadingNode, $createQuoteNode, $isHeadingNode, $isQuoteNode } = LexRichText;
import LexSelection from "@lexical/selection";
const { $getSelectionStyleValueForProperty, $isParentElementRTL, $patchStyleText, $setBlocksType } = LexSelection;
import LexTable from "@lexical/table";
const { $isTableNode } = LexTable;
import LexUtils from "@lexical/utils";
const { $findMatchingParent, $getNearestBlockElementAncestorOrThrow, $getNearestNodeOfType, mergeRegister } = LexUtils;
import Lex, { LexicalEditor, NodeKey, ElementFormatType } from "lexical";
const {
  $createParagraphNode,
  $getNodeByKey,
  $getRoot,
      ...
      {blockType === "code" ? (
        ...
        <>
          ...
          >
            ...
            <DropDownItem
              onClick={() => {
                showModal("Insert Inline Image", (onClose) => <InsertInlineImageDialog activeEditor={activeEditor} onClose={onClose} />);
              }}
              className="item"
            >
              <i className="icon image" />
