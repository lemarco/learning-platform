...
const { $createLinkNode } = LexLink;
import LexList from "@lexical/list";
const { $createListItemNode, $createListNode } = LexList;
import LexConposer from "@lexical/react/LexicalComposer";
const { LexicalComposer } = LexConposer;
import LexRichText from "@lexical/rich-text";
const { $createHeadingNode, $createQuoteNode } = LexRichText;
import Lex from "lexical";
const { $createParagraphNode, $createTextNode, $getRoot } = Lex;
...
function App(): JSX.Element {
  ...
  return (  <div className="editor-shell"> <LexicalComposer initialConfig={initialConfig}>
