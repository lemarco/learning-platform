      ...
      <section class="bg-white dark:bg-gray-900 h-[900px]">
        <div class=" py-8 px-4 my-auto mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6">
          ...
          <div class="mt-8 lg:mt-12 space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              {/* <FingerprintIcon class="mx-auto mb-4 w-12 h-12 text-primary-600 dark:text-primary-500" /> */}
            ...
            <div>
              {/* <NoteIcon class="mx-auto mb-4 w-12 h-12 text-primary-600 dark:text-primary-500" /> */}
            ...
            <div>
              {/* <CheckMarkIcon class="mx-auto mb-4 w-12 h-12 text-primary-600 dark:text-primary-500" /> */}
