...
import { LexicalContextMenuPlugin, MenuOption } from "../../../../editor";
import { type EditorNode, $getSelection, $isRangeSelection, COPY_COMMAND, CUT_COMMAND, PASTE_COMMAND } from "../../../../editor";
...
export class ContextMenuOption extends MenuOption {
  title: string;
  onSelect: (targetNode: EditorNode | null) => void;
  constructor(
    title: string,
    options: {
      onSelect: (targetNode: EditorNode | null) => void;
...
export function ContextMenuPlugin(): JSX.Element {
  ...
  const onSelectOption = useCallback(
    (selectedOption: ContextMenuOption, targetNode: EditorNode | null, closeMenu: () => void) => {
      editor.update(() => {
  ...
  return (
    <LexicalContextMenuPlugin
      ...
      menuRenderFn={(anchorElementRef, { selectedIndex, options: _options, selectOptionAndCleanUp, setHighlightedIndex }, { setMenuRef }) =>
