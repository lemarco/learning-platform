...
import { LexicalTypeaheadMenuPlugin, MenuOption, useBasicTypeaheadTriggerMatch } from "../../../../editor";
import { $createTextNode, $getSelection, $isRangeSelection, TextNode } from "../../../../editor";
...
export function EmojiPickerPlugin() {
  ...
  useEffect(() => {
    // @ts-ignore
    import("../../../../shared/utils/emoji-list").then((file) =>
      // @ts-ignore
