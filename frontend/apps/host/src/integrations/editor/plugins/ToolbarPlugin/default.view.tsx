...
import { $getSelectionStyleValueForProperty, $patchStyleText } from "features/editor";
...
export const DefaultView = ({
  ...
  return (
    <>
      ...
      <ListsDropDown disabled={!isEditable} blockType={blockType} editor={editor} />
      <HeadingDropDown disabled={!isEditable} blockType={blockType} editor={editor} />
      <QuoteButton disabled={!isEditable} blockType={blockType} editor={editor} />
      <DropdownColorPicker
        disabled={!isEditable}
      ...
      <OtherToolsDropdown activeEditor={activeEditor} editor={editor} showModal={showModal} />
