...
import { PlainTextPlugin } from "features/editor";
import { $getNodeByKey } from "features/editor";
  ...
  return (
    <div ref={stickyContainerRef} className="sticky-note-container">
      ...
      >
        ...
        <LexicalNestedComposer initialEditor={caption} initialTheme={{}}>
