import type { LexicalEditor, EditorNode } from "../../";

import { $createOverflowNode, $isOverflowNode, OverflowNode } from "../../";
import { $rootTextContent } from "../../";
import { $dfs, mergeRegister } from "../../";
import {
  $getSelection,
  $isLeafNode,
  $isRangeSelection,
...
function $wrapNode(node: EditorNode): OverflowNode {
...
function $unwrapNode(node: OverflowNode): EditorNode | null {
