...
import type { ElementNode, LexicalEditor, EditorNode } from "../core";
...
import { useLexicalComposerContext } from "../react";
...
function isPreviousNodeValid(node: EditorNode): boolean {
...
function isNextNodeValid(node: EditorNode): boolean {
...
function replaceWithChildren(node: ElementNode): Array<EditorNode> {
