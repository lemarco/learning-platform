import type { EditorNode, MutationListener } from "../";

import { $isLinkNode, AutoLinkNode, LinkNode } from "../";
import { useLexicalComposerContext } from "../";
import { EditorNodeMenuPlugin, MenuOption, MenuRenderFn } from "../";
...
export function LexicalAutoEmbedPlugin<TEmbedConfig extends EmbedConfig>({
  ...
  return nodeKey != null ? (
    <EditorNodeMenuPlugin<AutoEmbedOption>
      nodeKey={nodeKey}
      onClose={reset}
