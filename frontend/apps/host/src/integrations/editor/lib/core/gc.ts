...
import type { NodeKey, NodeMap } from "./nodes/editor";

import { $isElementNode } from ".";
import { cloneDecorators } from "./utils";
...
function $garbageCollectDetachedDeepChildNodes(
  ...
  while (child !== null) {
    ...
    // TODO Revise condition below, redundant? EditorNode already cleans up children when moving Nodes
