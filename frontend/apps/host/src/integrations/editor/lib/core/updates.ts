...
import type { EditorNode, SerializedEditorNode } from "./nodes/editor";
...
import { $normalizeTextNode } from "./normalization";
...
export function $applyTransforms(
  ...
  node: EditorNode,
  transformsCache: Map<string, Array<Transform<EditorNode>>>
) {
...
export function $parseSerializedNode(
  serializedNode: SerializedEditorNode
): EditorNode {
