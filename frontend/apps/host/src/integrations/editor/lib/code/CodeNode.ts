...
import type { CodeHighlightNode } from "../code";
...
import { addClassNamesToElement, isHTMLElement } from "../utils";
import {
...
function convertDivElement(domNode: Node): DOMConversionOutput {
  ...
  return {
    after: (childEditorNodes) => {
      const domParent = domNode.parentNode;
      if (domParent != null && domNode !== domParent.lastChild) {
        childEditorNodes.push($createLineBreakNode());
      }
      return childEditorNodes;
    },
    // @ts-ignore
