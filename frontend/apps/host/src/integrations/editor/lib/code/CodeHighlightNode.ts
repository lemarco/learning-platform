...
import { addClassNamesToElement, removeClassNamesFromElement } from "../utils";
import { $applyNodeReplacement, $isTabNode, ElementNode, TextNode } from "../";
...
export function $isCodeHighlightNode(
  node: EditorNode | CodeHighlightNode | null | undefined
