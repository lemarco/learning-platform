 ...
 */
export function $getTopListNode(listItem: EditorNode): ListNode {
...
export function findNearestListItemNode(
  ...
  let currentNode: EditorNode | null = node;
 ...
 */
export function wrapInListItem(node: EditorNode): ListItemNode {
