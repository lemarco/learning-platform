...
export class ListItemNode extends ElementNode {
  ...
  static transform(): (node: EditorNode) => void {
  ...
  insertAfter(node: EditorNode, restoreSelection = true): EditorNode {
  ...
  canMergeWith(node: EditorNode): boolean {
