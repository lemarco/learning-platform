...
const BlogPreview = () => {
    return html`<section class="bg-white dark:bg-gray-900 antialiased">
              ...
              <div class="mt-5 space-y-3">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="text-md font-medium leading-tight text-gray-900 dark:text-white">
                    ...
                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">Posted on Jan 31</div>
                  </div>
                </div>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <div class="flex justify-center items-center">
              ...
              <div>
                <label htmlFor="toggle-example" class="flex relative items-center mx-4 cursor-pointer">
                  <input type="checkbox" id="toggle-example" class="sr-only" />
                  <div class="w-11 h-6 bg-gray-200 rounded-full border-2 border-gray-200 toggle-bg dark:bg-gray-700 dark:border-gray-700" />
                </label>
              </div>
          ...
          <div class="grid gap-8 xl:grid-cols-3 xl:gap-10">
            <div class="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border border-gray-200 shadow xl:max-w-lg dark:border-gray-700 dark:bg-gray-800 xl:p-8">
              ...
              <p class="mt-4 mb-1 text-gray-500 text-light dark:text-gray-400">$19 USD per month, paid annually</p>
              <a
                href="/"
            ...
            <div class="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border shadow xl:max-w-lg border-primary-600 dark:bg-gray-800 xl:p-8">
              <div class="mb-2">
              ...
              <p class="mt-4 mb-1 text-gray-500 text-light dark:text-gray-400">$159 USD per month, paid annually</p>
              <a
                href="/"
                class="inline-flex justify-center items-center font-medium text-primary-600 hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700"
              >
            ...
            <div class="flex flex-col p-6 mx-auto max-w-xl text-center bg-white rounded-lg border border-gray-200 shadow xl:max-w-lg dark:border-gray-700 dark:bg-gray-800 xl:p-8">
              ...
              <p class="mt-4 mb-1 text-gray-500 text-light dark:text-gray-400">$499 USD per month, paid annually</p>
              <a
                href="/"
                class="inline-flex justify-center items-center font-medium text-primary-600 hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700"
              >
