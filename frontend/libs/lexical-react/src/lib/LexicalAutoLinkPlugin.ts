import type { LinkAttributes } from "@frontend/lexical-editor";
import type { ElementNode, LexicalEditor, LexicalNode } from "@frontend/lexical-editor";

import { $createAutoLinkNode, $isAutoLinkNode, $isLinkNode, AutoLinkNode } from "@frontend/lexical-editor";
...
import { invariant } from "@frontend/lexical-editor";
...
function isContentAroundIsValid(matchStart: number, matchEnd: number, text: string, nodes: TextNode[]): boolean {
...
function extractMatchingNodes(
  ...
  startIndex: number,
  endIndex: number,
): [matchingOffset: number, unmodifiedBeforeNodes: TextNode[], matchingNodes: TextNode[], unmodifiedAfterNodes: TextNode[]] {
...
function createAutoLinkNode(nodes: TextNode[], startIndex: number, endIndex: number, match: LinkMatcherResult): TextNode | undefined {
...
function handleLinkCreation(nodes: TextNode[], matchers: Array<LinkMatcher>, onChange: ChangeHandler): void {
