import type { ElementFormatType, NodeKey } from "@frontend/lexical-editor";
...
import { $getNearestBlockElementAncestorOrThrow, mergeRegister } from "@frontend/lexical-editor";
import {
  $getNodeByKey,
  $getSelection,
  $isDecoratorNode,
