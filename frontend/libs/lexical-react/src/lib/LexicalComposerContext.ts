import type { EditorThemeClasses, LexicalEditor } from "@frontend/lexical-editor";
...
export const LexicalComposerContext: React.Context<LexicalComposerContextWithEditor | null | undefined> = createReactContext<
