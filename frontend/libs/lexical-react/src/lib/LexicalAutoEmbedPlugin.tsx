import type { CommandListenerPriority, LexicalNode, MutationListener } from "@frontend/lexical-editor";

import { $isLinkNode, AutoLinkNode, LinkNode } from "@frontend/lexical-editor";
...
export function LexicalAutoEmbedPlugin<TEmbedConfig extends EmbedConfig>({
  ...
  useEffect(() => {
    ...
    return mergeRegister(
      ...[LinkNode, AutoLinkNode].map((Klass) => editor.registerMutationListener(Klass, (...args) => listener(...args))),
    );
