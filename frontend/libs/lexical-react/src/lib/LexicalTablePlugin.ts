import type { HTMLTableElementWithWithTableSelectionState, InsertTableCommandPayload, TableSelection } from "@frontend/lexical-editor";
import type { DEPRECATED_GridCellNode, NodeKey } from "@frontend/lexical-editor";
...
import { $insertFirst, $insertNodeToNearestRoot } from "@frontend/lexical-editor";
import {
  $getNodeByKey,
  $isTextNode,
  $nodesOfType,
