import type { LexicalEditor, LexicalNode } from "@frontend/lexical-editor";

import { $createOverflowNode, $isOverflowNode, OverflowNode } from "@frontend/lexical-editor";
import { $rootTextContent } from "@frontend/lexical-editor";
import { $dfs, mergeRegister } from "@frontend/lexical-editor";
import { $getSelection, $isLeafNode, $isRangeSelection, $isTextNode, $setSelection } from "@frontend/lexical-editor";
...
export function useCharacterLimit(editor: LexicalEditor, maxCharacters: number, optional: OptionalProps = Object.freeze({})): void {
  const {
