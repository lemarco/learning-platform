import type { Binding, ExcludedProperties, Provider } from "@frontend/lexical-editor";
...
export function useYjsFocusTracking(editor: LexicalEditor, provider: Provider, name: string, color: string, awarenessData?: object) {
  useEffect(() => {
