...
import type { ElementNode, LexicalNode, TextFormatType, TextNode } from "../../lexical/Lexical";

import { $getRoot, $isDecoratorNode, $isElementNode, $isLineBreakNode, $isTextNode } from "../../lexical/Lexical";
