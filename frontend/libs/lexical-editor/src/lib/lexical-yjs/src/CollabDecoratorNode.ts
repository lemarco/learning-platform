...
import type { DecoratorNode, NodeKey, NodeMap } from "@frontend/lexical-editor";
import type { XmlElement } from "yjs";

import { $getNodeByKey, $isDecoratorNode } from "@frontend/lexical-editor";
...
export function $createCollabDecoratorNode(xmlElem: XmlElement, parent: CollabElementNode, type: string): CollabDecoratorNode {
