...
import type { LexicalCommand } from "@frontend/lexical-editor";
import type { Doc, RelativePosition, UndoManager, XmlText } from "yjs";

import { createCommand } from "@frontend/lexical-editor";
...
export function initLocalState(provider: Provider, name: string, color: string, focusing: boolean, awarenessData: object): void {
...
export function setLocalStateFocus(provider: Provider, name: string, color: string, focusing: boolean, awarenessData: object): void {
