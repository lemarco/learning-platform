...
import type { NodeKey, NodeMap, TextNode } from "@frontend/lexical-editor";
import type { Map as YMap } from "yjs";

import { $getNodeByKey, $getSelection, $isRangeSelection, $isTextNode } from "@frontend/lexical-editor";
import { invariant } from "../../shared/src/invariant";
import { simpleDiffWithCursor } from "../../shared/src/simpleDiffWithCursor";

import { syncPropertiesFromLexical, syncPropertiesFromYjs } from "./Utils";

function diffTextContentAndApplyDelta(collabNode: CollabTextNode, key: NodeKey, prevText: string, nextText: string): void {
...
export function $createCollabTextNode(map: YMap<unknown>, text: string, parent: CollabElementNode, type: string): CollabTextNode {
