...
import { TestComposer, createTestEditor } from "lexical/src/__tests__/utils";
...
describe("LexicalHistory tests", () => {
  ...
  test("LexicalHistory.Redo after Quote Node", async () => {
    ...
    expect(((afterQuoteInsertionJSONState.root.children as SerializedElementNode[])[0].children[0] as SerializedTextNode).text).toBe("AAA");
