import type { EditorConfig, LexicalNode, NodeKey, SerializedTextNode } from "../../lexical/Lexical";

import { addClassNamesToElement } from "../../lexical-utils/LexicalUtils";
import { $applyNodeReplacement, TextNode } from "../../lexical/Lexical";
