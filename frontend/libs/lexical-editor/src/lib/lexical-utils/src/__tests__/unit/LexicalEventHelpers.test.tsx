...
import { TestComposer, initializeClipboard } from "lexical/src/__tests__/utils";
  ...
  describe("onPasteForRichText", () => {
    describe("baseline", () => {
      const suite = [
        ...
        },
        {
          ...
          inputs: [pasteHTML(`<meta charset='utf-8'>Welcome to<a href="https://facebook.com">Facebook!</a>We hope you like it here.`)],
        ...
        },
        {
          ...
          inputs: [
            pasteHTML(`<meta charset='utf-8'><doesnotexist><ul><li>Hello</li><li>from the other</li><li>side</li></ul></doesnotexist>`),
          ],
        ...
        },
        {
          ...
          inputs: [
            pasteHTML(`<meta charset='utf-8'>Welcome to<b><a href="https://facebook.com">Facebook!</a></b>We hope you like it here.`),
          ],
        ...
        },
        {
          ...
          inputs: [
            pasteHTML(`<meta charset='utf-8'>Welcome to<b><a href="https://facebook.com">Facebook!</a>We hope you like it here.</b>`),
          ],
    ...
    describe("W3 spacing", () => {
      const suite = [
        ...
        // },
        {
          expectedHTML: '<p class="editor-paragraph" dir="ltr"><strong class="editor-text-bold" data-lexical-text="true">a b</strong></p>',
          inputs: [
            pasteHTML(`
            <div>
              <strong>
