...
import { $createRangeSelection, $getRoot, $isElementNode, $setSelection } from "lexical";
  ...
  const testCases: Array<{
    ...
    },
    {
      ...
      expectedHtml:
        ...
        "</ul>",
      initialHtml:
        "<ul>" + "<li><span>Before</span></li>" + "<ul><li><span>Helloworld</span></li></ul>" + "<li><span>After</span></li>" + "</ul>",
      selectionOffset: 5, // Selection on text node after "Hello" world
    ...
    },
    {
      ...
      expectedHtml: '<p><span style="white-space: pre-wrap;">Hello world</span></p>' + "<test-decorator></test-decorator>" + "<p><br></p>",
    ...
    },
    {
      ...
      expectedHtml: "<p><br></p>" + "<test-decorator></test-decorator>" + '<p><span style="white-space: pre-wrap;">Hello world</span></p>',
      initialHtml: "<p>Hello world</p>",
      selectionOffset: 0, // Selection on text node after "Hello" world
      selectionPath: [0, 0],
    },
    ...
    },
    {
      ...
      expectedHtml: '<p><span style="white-space: pre-wrap;">Before</span></p>' + "<test-decorator></test-decorator>",
