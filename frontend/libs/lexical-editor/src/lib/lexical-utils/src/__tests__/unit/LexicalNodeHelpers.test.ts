import { $createParagraphNode, $createTextNode, $getNodeByKey, $getRoot, $isElementNode, LexicalEditor, NodeKey } from "lexical";
import { $createTestElementNode, initializeUnitTest, invariant } from "lexical/src/__tests__/utils";
