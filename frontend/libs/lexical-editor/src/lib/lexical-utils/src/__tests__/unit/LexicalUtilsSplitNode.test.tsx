...
describe("LexicalUtils#splitNode", () => {
  ...
  const testCases: Array<{
  ...
  }> = [
    {
      ...
      expectedHtml: '<p><span style="white-space: pre-wrap;">Hello</span></p><p><span style="white-space: pre-wrap;">world</span></p>',
    ...
    },
    {
      ...
      expectedHtml: '<p><br></p><p><span style="white-space: pre-wrap;">Hello</span><span style="white-space: pre-wrap;">world</span></p>',
      initialHtml: "<p><span>Hello</span><span>world</span></p>",
      splitOffset: 0,
      splitPath: [0],
    },
    {
      ...
      expectedHtml: '<p><span style="white-space: pre-wrap;">Hello</span><span style="white-space: pre-wrap;">world</span></p><p><br></p>',
      initialHtml: "<p><span>Hello</span><span>world</span></p>",
