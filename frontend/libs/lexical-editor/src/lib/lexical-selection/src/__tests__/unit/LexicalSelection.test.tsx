...
describe("LexicalSelection tests", () => {
  ...
  const suite = [
    ...
    },
    {
      ...
      inputs: [formatItalic(), formatBold(), insertText("H"), insertText("e"), insertText("l"), insertText("l"), insertText("o")],
    ...
    },
    {
      ...
      inputs: [formatStrikeThrough(), insertText("H"), insertText("e"), insertText("l"), insertText("l"), insertText("o")],
    ...
    },
    {
      ...
      inputs: [insertText("Dominic Gannaway"), moveNativeSelection([0, 0, 0], 0, [0, 0, 0], 16), convertToSegmentedNode()],
    ...
    },
    {
      ...
      inputs: [insertParagraph(), insertText("Hello world"), insertParagraph(), moveNativeSelection([0], 0, [2], 0), formatBold()],
    ...
    },
    {
      ...
      inputs: [insertText("Hello"), insertParagraph(), insertText("world"), moveNativeSelection([0, 0, 0], 2, [1, 0, 0], 2), formatBold()],
    ...
    },
    {
      ...
      inputs: [insertParagraph(), insertText("Hello world"), insertParagraph(), moveNativeSelection([1, 0, 0], 6, [2], 0), formatBold()],
    ...
    },
    {
      ...
      inputs: [insertParagraph(), insertText("Hello world"), insertParagraph(), moveNativeSelection([0], 0, [1, 0, 0], 5), formatBold()],
    ...
    ...[
      ...
      },
      {
        ...
        inputs: [insertText(`Hello${whitespaceCharacter}world`), moveNativeSelection([0, 0, 0], 0, [0, 0, 0], 0), deleteWordForward(1)],
      ...
      },
      {
        ...
        inputs: [insertText(`Hello${whitespaceCharacter}world`), moveNativeSelection([0, 0, 0], 5, [0, 0, 0], 5), deleteWordForward(1)],
      ...
      },
      {
        ...
        inputs: [insertText(`Hello${whitespaceCharacter}world`), moveNativeSelection([0, 0, 0], 6, [0, 0, 0], 6), deleteWordBackward(1)],
          ...
          test_(name, async () => {
            await ReactTestUtils.act(async () => {
              await editor.update(() => {
                ...
                const { expectedAnchor, expectedAnchorOffset, expectedFocus, expectedFocusOffset } = fn(paragraph, textNode);
