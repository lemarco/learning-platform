...
import type { DOMConversionMap, DOMConversionOutput, DOMExportOutput, NodeKey, SerializedLexicalNode } from "../LexicalNode";
...
export class TextNode extends LexicalNode {
  ...
  exportDOM(editor: LexicalEditor): DOMExportOutput {
    ...
    invariant(element !== null && isHTMLElement(element), "Expected TextNode createDOM to always return a HTMLElement");
