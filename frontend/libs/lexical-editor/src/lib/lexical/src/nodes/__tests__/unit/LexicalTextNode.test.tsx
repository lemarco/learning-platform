...
describe("LexicalTextNode tests", () => {
  ...
  describe("createDOM()", () => {
    test.each([
      ...
      ["code", IS_CODE, "My text node", '<code spellcheck="false"><span class="my-code-class">My text node</span></code>'],
      [
      ...
      [
        ...
        "My text node",
        '<code spellcheck="false"><span class="my-underline-strikethrough-class my-code-class">' + "My text node</span></code>",
      ],
      [
        "highlight + italic",
