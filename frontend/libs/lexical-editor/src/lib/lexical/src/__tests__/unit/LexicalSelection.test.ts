...
import { $createParagraphNode, $createTextNode, $getRoot, $isParagraphNode, $isTextNode, LexicalEditor, RangeSelection } from "lexical";
      ...
      const setup = async (mode: "start-of-paragraph" | "mid-paragraph" | "end-of-paragraph") => {
        ...
        await editor.update(() => {
          ...
          if (mode === "start-of-paragraph") {
            ...
            paragraph.append($createTextNode("a"), $createLinkNode("https://", {}).append($createTextNode("b")), $createTextNode("c"));
          } else {
