...
import { $createTestInlineElementNode, TestElementNode, TestInlineElementNode, initializeUnitTest } from "../utils";
  ...
  initializeUnitTest(
    (testEnv) => {
      ...
      test("LexicalNode.insertAfter() move blocks around", async () => {
        const { editor } = testEnv;
        let block1: ParagraphNode, block2: ParagraphNode, block3: ParagraphNode, text1: TextNode, text2: TextNode, text3: TextNode;
