...
export class GridSelection extends INTERNAL_PointSelection {
  ...
  insertNodes(nodes: Array<LexicalNode>) {
    ...
    invariant($isElementNode(focusNode), "Expected GridSelection focus to be an ElementNode");
  ...
  getShape(): GridSelectionShape {
    ...
    invariant(DEPRECATED_$isGridCellNode(anchorCellNode), "Expected GridSelection anchor to be (or a child of) GridCellNode");
    const anchorCellNodeRect = DEPRECATED_$getGridCellNodeRect(anchorCellNode);
    invariant(anchorCellNodeRect !== null, "getCellRect: expected to find AnchorNode");

    const focusCellNode = $getNodeByKey(this.focus.key);
    invariant(DEPRECATED_$isGridCellNode(focusCellNode), "Expected GridSelection focus to be (or a child of) GridCellNode");
    const focusCellNodeRect = DEPRECATED_$getGridCellNodeRect(focusCellNode);
    invariant(focusCellNodeRect !== null, "getCellRect: expected to find focusCellNode");
  ...
  getNodes(): Array<LexicalNode> {
    ...
    invariant(DEPRECATED_$isGridCellNode(anchorCell), "Expected GridSelection anchor to be (or a child of) GridCellNode");
    ...
    if (focusCellGrid !== gridNode) {
      if (!gridNode.isParentOf(focusCell)) {
        ...
        invariant(focusCellParent != null, "Expected focusCellParent to have a parent");
