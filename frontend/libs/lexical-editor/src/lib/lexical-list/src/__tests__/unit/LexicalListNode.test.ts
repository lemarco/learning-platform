...
describe("LexicalListNode tests", () => {
  initializeUnitTest((testEnv) => {
    ...
    test("ListNode.createDOM()", async () => {
      ...
      await editor.update(() => {
        const listNode = $createListNode("bullet", 1);
        expect(listNode.createDOM(editorConfig).outerHTML).toBe('<ul class="my-ul-list-class my-ul-list-class-1"></ul>');
        expect(
          listNode.createDOM({
            namespace: "",
            theme: {
    ...
    test("ListNode.createDOM() correctly applies classes to a nested ListNode", async () => {
      ...
      await editor.update(() => {
        ...
        expect(listNode1.createDOM(editorConfig).outerHTML).toBe('<ul class="my-ul-list-class my-ul-list-class-1"></ul>');
        expect(
          listNode1.createDOM({
            namespace: "",
            theme: {
        ...
        expect(listNode2.createDOM(editorConfig).outerHTML).toBe('<ul class="my-ul-list-class my-ul-list-class-2"></ul>');
        expect(listNode3.createDOM(editorConfig).outerHTML).toBe('<ul class="my-ul-list-class my-ul-list-class-3"></ul>');
        expect(listNode4.createDOM(editorConfig).outerHTML).toBe('<ul class="my-ul-list-class my-ul-list-class-4"></ul>');
        expect(listNode5.createDOM(editorConfig).outerHTML).toBe('<ul class="my-ul-list-class my-ul-list-class-5"></ul>');
        expect(listNode6.createDOM(editorConfig).outerHTML).toBe('<ul class="my-ul-list-class my-ul-list-class-6"></ul>');
        expect(listNode7.createDOM(editorConfig).outerHTML).toBe('<ul class="my-ul-list-class my-ul-list-class-7"></ul>');
        expect(
          listNode5.createDOM({
            namespace: "",
            theme: {
